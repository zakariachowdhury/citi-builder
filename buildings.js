...
window.Buildings = (function() {
  ...
  // Group definitions, displayed top-to-bottom in the sidebar.
  const GROUPS = [
    { id: 'homes',     label: 'Homes',           emoji: '🏘' },
    { id: 'civic',     label: 'Civic & Worship', emoji: '🏛' },
    { id: 'shops',     label: 'Shops & Food',    emoji: '🛍' },
    { id: 'parks',     label: 'Parks & Play',    emoji: '🌿' },
    { id: 'nature',    label: 'Nature',          emoji: '🌳' },
    { id: 'street',    label: 'Street stuff',    emoji: '🚦' },
    { id: 'vehicles',  label: 'Vehicles',        emoji: '🚗' },
    { id: 'landmarks', label: 'Landmarks',       emoji: '✨' },
  ];

  const REQUIRED = [
    { kind: 'home',       label: 'Home',          group: 'homes',     required: true,  color: '#d4a574', size: 36, draw: home,       hint: 'Place at least 12 in a neighborhood', stackable: true },
    { kind: 'library',    label: 'Library',       group: 'civic',     required: true,  color: '#bfdbfe', size: 56, draw: lib,        hint: 'Vertical angles with a Park' },
    { kind: 'school',     label: 'School',        group: 'civic',     required: true,  color: '#f7d28a', size: 60, draw: school,     hint: 'Right-angle corner with the Park' },
    { kind: 'masjid',     label: 'Masjid',        group: 'civic',     required: true,  color: '#e6c98a', size: 60, draw: masjid,     hint: 'On an acute-angle intersection' },
    { kind: 'police',     label: 'Police Station',group: 'civic',     required: true,  color: '#9aa8c8', size: 50, draw: police,     hint: 'Alternate interior angles with Fire Dept' },
    { kind: 'fire',       label: 'Fire Dept',     group: 'civic',     required: true,  color: '#d94c3a', size: 56, draw: fire,       hint: 'Alternate interior angles with Police' },
    { kind: 'grocery',    label: 'Grocery Store', group: 'shops',     required: true,  color: '#f4d35e', size: 56, draw: grocery,    hint: 'On an obtuse-angle intersection' },
    { kind: 'movie',      label: 'Movie Theater', group: 'shops',     required: true,  color: '#8a5fb0', size: 56, draw: movie,      hint: 'Supplementary angles with the Restaurant' },
    { kind: 'restaurant', label: 'Restaurant',    group: 'shops',     required: true,  color: '#f0a978', size: 52, draw: restaurant, hint: 'On a transversal; supplementary with Movie Theater' },
    { kind: 'gas',        label: 'Gas Station',   group: 'shops',     required: true,  color: '#d94c3a', size: 50, draw: gas,        hint: 'Alternate exterior angles with the Bank' },
    { kind: 'bank',       label: 'Bank',          group: 'shops',     required: true,  color: '#cdb992', size: 56, draw: bank,       hint: 'Alternate exterior angles with the Gas Station' },
    { kind: 'mall',       label: 'Mall',          group: 'shops',     required: true,  color: '#f0c0d0', size: 70, draw: mall,       hint: 'Right-angle corner' },
    { kind: 'icecream',   label: 'Ice Cream',     group: 'shops',     required: true,  color: '#f8d4e0', size: 50, draw: icecream,   hint: 'Consecutive interior angles with Arcade' },
    { kind: 'arcade',     label: 'Arcade',        group: 'shops',     required: true,  color: '#3b6fb5', size: 50, draw: arcade,     hint: 'Consecutive interior angles with Ice Cream' },
    { kind: 'park',       label: 'Park',          group: 'parks',     required: true,  color: '#cbe6a8', size: 60, draw: park,       hint: 'Right-angle corner with the School; vertical angles with the Library' },
    { kind: 'pool',       label: 'Pool',          group: 'parks',     required: true,  color: '#7ec0d8', size: 70, draw: pool,       hint: 'Oval pool — near Ice Cream & Arcade' },
  ];

  const DECOR = [
    { kind: 'hospital',   label: 'Hospital',      group: 'civic',     size: 56, draw: hospital,        stackable: true },
    { kind: 'museum',     label: 'Museum',        group: 'civic',     size: 60, draw: museum,          stackable: true },
    { kind: 'church',     label: 'Church',        group: 'civic',     size: 56, draw: church,          stackable: true },
    { kind: 'shop',       label: 'Shop',          group: 'shops',     size: 44, draw: shop,            stackable: true },
    { kind: 'donut',      label: 'Donut Shop',    group: 'shops',     size: 50, draw: donutShop,       stackable: true },
    { kind: 'hotel',      label: 'Hotel',         group: 'shops',     size: 60, draw: hotel,           stackable: true },
    { kind: 'amusement',  label: 'Amusement Park',group: 'parks',     size: 64, draw: amusementPark,   stackable: true },
    { kind: 'playground', label: 'Playground',    group: 'parks',     size: 48, draw: playground,      stackable: true },
    { kind: 'gazebo',     label: 'Gazebo',        group: 'parks',     size: 36, draw: gazebo,          stackable: true },
    { kind: 'soccer',     label: 'Soccer Field',  group: 'parks',     size: 64, draw: soccerField,     stackable: true },
    { kind: 'tennis',     label: 'Tennis Court',  group: 'parks',     size: 56, draw: tennisCourt,     stackable: true },
    { kind: 'volleyball', label: 'Volleyball',    group: 'parks',     size: 56, draw: volleyballCourt, stackable: true },
    { kind: 'basketball', label: 'Basketball',    group: 'parks',     size: 56, draw: basketballCourt, stackable: true },
    { kind: 'golf',       label: 'Golf Course',   group: 'parks',     size: 64, draw: golfCourse,      stackable: true },
    { kind: 'fountain',   label: 'Fountain',      group: 'parks',     size: 34, draw: fountain,        stackable: true },
    { kind: 'tree',       label: 'Tree',          group: 'nature',    size: 24, draw: tree,            stackable: true },
    { kind: 'flower',     label: 'Flower',        group: 'nature',    size: 16, draw: flower,          stackable: true },
    { kind: 'pond',       label: 'Pond',          group: 'nature',    size: 50, draw: pond,            stackable: true },
    { kind: 'busStop',    label: 'Bus Stop',      group: 'street',    size: 24, draw: busStop,         stackable: true },
    { kind: 'streetlight',label: 'Streetlight',   group: 'street',    size: 26, draw: streetlight,     stackable: true },
    { kind: 'parkingLot', label: 'Parking Lot',   group: 'street',    size: 48, draw: parkingLot,      stackable: true },
    { kind: 'mailbox',    label: 'Mailbox',       group: 'street',    size: 18, draw: mailbox,         stackable: true },
    { kind: 'bench',      label: 'Bench',         group: 'street',    size: 24, draw: bench,           stackable: true },
    { kind: 'car',        label: 'Car',           group: 'vehicles',  size: 22, draw: car,             stackable: true },
    { kind: 'bus',        label: 'Bus',           group: 'vehicles',  size: 44, draw: bus,             stackable: true },
  ...
  return { REQUIRED, DECOR, ALL, GROUPS, getDef };
})();
